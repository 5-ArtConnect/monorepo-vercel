...
function FeaturedGallery({ items = [], navigate }) {
  return (
    <section className="max-w-7xl mx-auto px-6 py-12">
      ...
      <div className="text-center mt-8">
        <button 
          onClick={() => navigate('/gallery')}
          className="bg-[#463b33] text-white px-8 py-3 rounded hover:bg-[#5a4a42] transition-colors font-semibold"
        >
          See More Gallery
        </button>
      </div>
  ...
  return (
    <div className="font-poppins bg-[#F7F1EB] text-[#111827] min-h-screen flex flex-col">
      ...
      <div className="pt-[80px]">
        ...
        <FeaturedGallery items={featuredArtworks} navigate={navigate} />
