...
function ArtistsSection({ artists = [] }) {
  ...
  return (
    <section className="bg-[#FAF7F0] text-black py-12 mt-24">
      <div className="max-w-7xl mx-auto px-6 text-center">
        <h3 className="text-3xl font-extrabold mb-2">Artist Of Community</h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4 justify-center">
          {artists.map((a, i) => (
            <div key={i} className="rounded-xl p-2 flex flex-col items-center select-none">
              <img
                src={a.image}
                alt={a.name ? `Portrait or work by ${a.name}` : `Artist ${i + 1}`}
                className="w-full h-48 sm:h-56 md:h-64 object-cover rounded-lg shadow transition-transform duration-300 ease-out hover:scale-105 cursor-pointer"
                draggable="false"
              ...
              <div className="font-bold italic text-sm sm:text-base mt-2">{a.name}</div>
            </div>
          ))}
        </div>
        ...
        {activeImage && (
          ...
          >
            <div className="max-w-4xl w-full rounded-lg overflow-hidden">
              <img src={activeImage} alt="Preview" className="w-full h-auto object-contain" />
            </div>
          </div>
        )}
      </div>
...
export default function ArtConnectHomepage() {
  ...
  // sample artists list (pakai asset local)
  const artists = [
    { id: "mario", name: "Mario", image: mario },
    { id: "hanna", name: "Hanna", image: hanna },
    { id: "sejong", name: "Sejong", image: sejong },
    { id: "mario", name: "Mario", image: mario },
    { id: "hanna", name: "Hanna", image: hanna },
  ];
    ...
    <div className="min-h-screen bg-stone-50">
      ...
      <section className="max-w-7xl mx-auto px-6 py-20">
        <div className="text-center mb-12">
          ...
          <p className="text-[#666666] font-semibold mb-24 max-w-3xl mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center mb-12">
          ...
          <div className="space-y-6">
            <div className="bg-[#463D38] text-white p-8 rounded-2xl shadow-lg">
            ...
            <button
              ...
              className="bg-[#8D8079] text-white px-8 py-3 rounded-full font-semibold hover:bg-[#463D38] transition duration-200"
            >
              Join Community
            </button>
          </div>
      ...
      {/* Upcoming Events */}
      <section className="max-w-7xl mx-auto px-6 py-20 bg-stone-100 shadow- rounded-3xl mb-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-4 bg-[#FAF7F0]">
            {events.map((event, idx) => (
              <div key={idx} className="flex gap-4 items-start bg-white p-4 rounded-xl shadow-sm">
                <div className="w-3 h-3 bg-gray-800 rounded-full mt-1 shadow-3xl flex-shrink-0" />
                <div>
